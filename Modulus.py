class Modulus:
    ...
    def __add__(self, other):  
        if isinstance(other, int):  
            return Modulus(self.num + other, self.mod)  
    ...
    def __iadd__(self, other):
        if isinstance(other, int):  
            self = Modulus(self.num + other, self.mod)  
            return self
        elif isinstance(other, Modulus):  
            if other.mod != self.mod:  
                raise ValueError
    ...
    def __sub__(self, other):  
        if isinstance(other, int):  
            return Modulus(self.num - other % self.mod + self.mod, self.mod)
        elif isinstance(other, Modulus):  
            if other.mod != self.mod:  
                raise ValueError  
            else:  
    ...
    def __isub__(self, other):  
        if isinstance(other, int):  
            self = Modulus(self.num - other % self.mod + self.mod, self.mod)
            return self
        elif isinstance(other, Modulus):  
            if other.mod != self.mod:  
                raise ValueError
    ...
    def __floordiv__(self, other):
        if isinstance(other, int):  
            return Modulus(self.num * pow(other, self.mod - 2, self.mod), self.mod)
        elif isinstance(other, Modulus):  
            if other.mod != self.mod:  
                raise ValueError  
            else:  
                return Modulus(self.num * pow(other.num, self.mod - 2, self.mod), self.mod)
        else:  
            raise TypeError
    ...
    def __ifloordiv__(self, other):
        if isinstance(other, int):  
            self = Modulus(self.num * pow(other, self.mod - 2, self.mod), self.mod)
            return self
        elif isinstance(other, Modulus):  
            if other.mod != self.mod:  
                raise ValueError  
    ...
    def __neg__(self):
        return Modulus(self.mod - self.num if self.num != 0 else 0, self.mod)
